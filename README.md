...
- **New terminal / new session** — **+ New terminal** opens a plain shell in the selected session's directory; **+ New Claude session** starts a fresh `claude` there, which then shows up in the sidebar on its own.
